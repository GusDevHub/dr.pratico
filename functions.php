...
function tema_setup() {
	...
	load_theme_textdomain( 'JGTemas', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary'             => esc_html__( 'Primary',             'JGTemas' ),
	) );
...
function tema_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'JGTemas' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
print "<!-- favicon -->
<link rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"{$url_template}/favicon/apple-touch-icon.png\">
<link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"{$url_template}/favicon/favicon-32x32.png\">
<link rel=\"icon\" type=\"image/png\" sizes=\"192x192\" href=\"{$url_template}/favicon/android-chrome-192x192.png\">
<link rel=\"icon\" type=\"image/png\" sizes=\"16x16\" href=\"{$url_template}/favicon/favicon-16x16.png\">
<link rel=\"manifest\" href=\"{$url_template}/favicon/site.webmanifest\">
<link rel=\"mask-icon\" href=\"{$url_template}/favicon/safari-pinned-tab.svg\" color=\"#2ebec7\">
<link rel=\"shortcut icon\" href=\"{$url_template}/favicon/favicon.ico\">
<meta name=\"msapplication-TileColor\" content=\"#23939a\">
...
<meta name=\"theme-color\" content=\"#23939a\">
";
}
